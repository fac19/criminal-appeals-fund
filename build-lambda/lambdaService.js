!(function (e, t) {
	...
	(function (e) {
		...
		407: function (e, t, r) {
			...
			const o = r
				.n(n)
				.a.create({ baseURL: "/.netlify/functions", timeout: 1e4 });
			o.interceptors.response.use(
				...
				(t.default = {
					fetchRecords: () => o.get("airtable").then((e) => e.data),
				});
		},
		408: function (e, t, r) {
			"use strict";
			...
			e.exports = function (e) {
				return new Promise(function (t, r) {
					...
					e.socketPath
						...
						: ((j.hostname = R.hostname), (j.port = R.port));
					var A,
						S = e.proxy;
					if (!S && !1 !== S) {
						...
						if (k) {
							...
							if (N && ((S = { host: T.hostname, port: T.port }), T.auth)) {
								var L = T.auth.split(":");
					...
					if (
						...
						((j.hostname = S.host),
						(j.host = S.host),
						(j.headers.host = R.hostname + (R.port ? ":" + R.port : "")),
						(j.port = S.port),
						(j.path =
							_ + "//" + R.hostname + (R.port ? ":" + R.port : "") + j.path),
						S.auth)
					) {
						var U = Buffer.from(
					...
					e.transport
						...
						e.maxContentLength &&
							...
							(j.maxBodyLength = e.maxContentLength);
					var M = A.request(j, function (t) {
						if (!M.aborted) {
							var r = t;
		...
		422: function (e, t, r) {
			...
			((t = e.exports = r(167)).log = function () {
				return (
		...
		424: function (e, t, r) {
			var n = r(425),
				o = r(2);
			((t = e.exports = r(167)).init = function (e) {
				e.inspectOpts = {};
